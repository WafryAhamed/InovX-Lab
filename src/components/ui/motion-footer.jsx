...
// -------------------------------------------------------------------------
const items = [
  ["AI-Driven Systems", "Data Intelligence", "Smart Automation", "Secure Infrastructure", "Real-Time Insights"],
  ["Predictive Models", "Workflow Automation", "Cloud AI", "Scalable Systems", "Deep Learning"],
];
      ...
      */}
      ...
      >
        ...
        <footer className="fixed bottom-0 left-0 flex h-screen w-full flex-col justify-between overflow-hidden bg-background text-foreground cinematic-footer-wrapper">
          ...
          <div className="absolute top-12 left-0 w-full overflow-hidden border-y border-border/50 bg-background/60 backdrop-blur-md py-3 z-10 -rotate-2 scale-105 shadow-2xl">
            <div className="flex w-max animate-footer-scroll-marquee text-[10px] md:text-xs font-bold tracking-widest text-muted-foreground uppercase">
              <MarqueeItem />
              <MarqueeItem />
            </div>
          </div>
          ...
          <div className="relative z-20 w-full pb-8 px-6 md:px-12 flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            {/* Copyright */}
            <div className="footer-glass-pill px-6 py-3 rounded-full flex items-center gap-2 order-2 md:order-1 cursor-default border-border/50">
              <span className="text-muted-foreground text-[10px] md:text-xs font-semibold tracking-widest uppercase">
                © 2026 InovX Lab. All rights reserved.
              </span>
            </div>
